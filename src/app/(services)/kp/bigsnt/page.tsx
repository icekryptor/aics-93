  ...
  return (
    <div className="text-runtime-ink">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-5 pb-14 pt-20 sm:px-8 sm:pt-28 xl:pl-[220px] min-[1720px]:pl-8">
      ...
      <div className="mx-auto w-full max-w-7xl px-5 pb-20 sm:px-8 xl:pl-[220px] min-[1720px]:pl-8">
        {/* ---------- 01 что увидел ---------- */}
