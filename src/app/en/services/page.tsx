...
import { enServicesIndex, enHome } from "@/lib/en/content";
...
export const metadata: Metadata = {
  title: enServicesIndex.metaTitle,
  description: enServicesIndex.metaDescription,
  alternates: {
  ...
  twitter: { card: "summary_large_image", title: enServicesIndex.metaTitle },
};
...
export default function EnServicesIndex() {
