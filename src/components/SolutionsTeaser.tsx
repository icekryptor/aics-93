...
// covers — видео лендинга (фолбэк: генеративный арт).
...
export default function SolutionsTeaser() {
  ...
  return (
    <section id="solutions" className="relative scroll-mt-24 py-[40px] lg:py-[64px]">
      <div className="mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-16">
        <div className="flex items-end justify-between border-b border-line pb-5">
          <div>
            <p className="tech-label text-[11px] text-ink-soft">[ решения · по направлениям ]</p>
            <h2 className="mt-3 text-[clamp(1.55rem,3.4vw,2.9rem)] font-normal leading-tight tracking-[-0.015em] text-ink">
              Готовые связки <span className="signal-text">под модель вашего бизнеса</span>
            </h2>
          </div>
          <Link
            href="/solutions"
