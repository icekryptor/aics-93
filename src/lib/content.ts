...
export const reasons = [
  {
    title: "Своя площадка — свои правила",
    text: "На собственном сайте вы сами управляете KPI, а не алгоритмы маркетплейса.",
  },
  {
    title: "Вас находят по брендовым запросам",
  ...
  },
  {
    ...
    text: "Товарные знаки и интеллектуальную собственность намного проще защитить — вы спокойны за неприкосновенность ваших усилий.",
  },
  {
    title: "Отстройка от конкурентов",
    text: "Узнаваемый бренд с репутацией — серьёзный аргумент для вашей целевой аудитории выбрать именно вас.",
  },
];
...
export const gantt = {
  ...
  scope: [
    "Сайт с 6 подстраницами, блогом и каталогом типовых проектов",
    "Подготовка к запуску рекламной кампании, подключение аналитики",
    "Интеграция сайта с amoCRM",
  ],
  phases: [
    { name: "Маркетинговое исследование", days: 4 },
    { name: "Прототипирование и копирайтинг", days: 4 },
    { name: "Разработка дизайн-макетов", days: 6 },
    { name: "Вёрстка, интеграция, запуск", days: 6 },
  ],
  team: [
    { name: "Василий", role: "Главный Пчёл проекта" },
    { name: "Артём", role: "Маркетолог-аналитик" },
    { name: "Виталий", role: "Front-end разработчик" },
  ],
  duration: "20 дней",
  budget: "190 000 ₽",
  budgetFinal: "159 000 ₽",
