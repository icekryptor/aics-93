...
export const heroStats = [
  {
    big: "7–14 дней",
    text: "от брифа до запуска сайта: ИИ-конвейер делает работу четверых специалистов",
  },
  {
    big: "до 70%",
    text: "экономия бюджета против классической студии — разница остаётся в вашем бизнесе",
  },
  {
    big: "10 лет",
