...
export const kpEntries: KpEntry[] = [
  ...
  },
  {
    ...
    client: "cooleso.ru",
    subject:
      "Разбор сайта на Tilda по трём параметрам (скорость, владение, возраст дизайна) с расчётом окупаемости; перенос на свой код с переработкой дизайна и обучением маркетологов ИИ-правкам",
    price: "210 000 ₽",
    priceNote: "33/33/34 · при полной предоплате 180 000 ₽ · неустойка в договоре",
    term: "до 3 недель",
    sent: "19.09.2026",
    status: "Опубликовано 19.09.2026, обновлено 20.09: скрины PageSpeed и Lighthouse (мобильный прогон не завершается — PAGE_HUNG), личное обращение с разбором ограничений Тильды, стек с логотипами, pet-проекты, цена 210к/180к. CTA ведёт в Telegram (квиза нет — формат разбора).",
    state: "draft",
    variants: [
      { label: "оффер · разбор", href: "/kp/cooleso", note: "тёмный одностраничник: 3 параметра, таблица владения, окупаемость, CTA в Telegram" },
    ],
  },
  {
    id: "bigsnt",
    ...
    subject:
      "Свой канал продаж вместо пустого сайта под Директом: аудит, экономика заказа WB/Ozon против сайта (с поправкой на СПП), два объёма работ от 64 до 100 часов",
    price: "320 / 500 тыс. ₽",
