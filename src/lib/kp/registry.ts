...
export const kpEntries: KpEntry[] = [
  ...
  },
  {
    ...
    priceNote: "перенос как есть или с апдейтом дизайна · обучение включено",
    term: "неделя",
    sent: "19.09.2026",
    status: "Опубликовано 19.09.2026, обновлено 20.09: свежие данные PageSpeed со скринами отчёта (моб + десктоп), два варианта цены. CTA ведёт в Telegram (квиза нет — формат разбора).",
    state: "draft",
    variants: [
