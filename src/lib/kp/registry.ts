...
export const kpEntries: KpEntry[] = [
  {
    id: "bigsnt",
    client: "BIGSNT · спортивное питание BIG",
    subject:
      "Свой канал продаж вместо пустого сайта под Директом: аудит, экономика заказа WB/Ozon против сайта (с поправкой на СПП), три объёма работ от 64 до 150 часов",
    price: "320 / 500 / 750 тыс. ₽",
    priceNote: "5 000 ₽/час, часы по этапам открыты · 50/50",
    term: "10–28 дней",
    sent: "05.09.2026",
    status:
      "Черновик собран 05.09.2026, ждёт отправки. Скриншоты сайта сняты в тот же день — перед отправкой перепроверить, не наполнили ли каталог.",
    state: "draft",
    variants: [
      { label: "студийный вид", href: "/kp/bigsnt", note: "тёмная сцена, канон ДС; калькулятор заказа, Директ, Гант с переключателем объёма" },
      { label: "документ · сериф", href: "/kp/bigsnt/doc", note: "светлый лист, под вдумчивое чтение и печать" },
    ],
  },
  {
    id: "gagarin",
