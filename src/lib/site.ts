...
export const SITE_DESCRIPTION =
  "Студия AICS-93: разработка сайтов под ключ за 7–14 дней, фирменный стиль и дизайн-системы, веб-сервисы и внедрение ИИ в процессы. Один инженер + ИИ-движок вместо агентства — студийное качество, экономия бюджета до 70%.";
